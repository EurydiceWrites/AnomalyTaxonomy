...
# Sub-case definitions: (case_number, encounter_id, line_start, line_end, bullard_page, pdf_page)
SUBCASES = [
    ('195a', 226, 10292, 10298, 'C-188', '208'),
    ('195b', 227, 10299, 10304, 'C-188', '208'),
    ('195c', 228, 10305, 10314, 'C-188', '208'),
    ('195d', 229, 10315, 10319, 'C-188', '208'),
    ('195e', 230, 10320, 10326, 'C-188', '208'),
    ('195f', 231, 10327, 10350, 'C-188', '208'),
    ('195g', 232, 10351, 10355, 'C-189', '209'),
    ('195h', 233, 10356, 10360, 'C-189', '209'),
    ('195i', 234, 10361, 10363, 'C-189', '209'),
    ('195j', 235, 10364, 10370, 'C-189', '209'),
    ('195k', 236, 10371, 10386, 'C-189', '209'),
    ('195l', 237, 10387, 10395, 'C-190', '210'),
    ('195m', 238, 10396, 10409, 'C-190', '210'),
    ('195n', 239, 10410, 10417, 'C-190', '210'),
    ('195o', 240, 10418, 10424, 'C-190', '210'),
    ('195p', 241, 10425, 10428, 'C-190', '210'),
    ('195q', 242, 10429, 10433, 'C-190', '210'),
]
